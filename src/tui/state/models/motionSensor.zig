...
pub const MotionSensor = struct {
    ...
    pub fn fromJson(alloc: std.mem.Allocator, obj: std.json.ObjectMap) MotionSensor {
        return .{
            .alloc = alloc,
    ...
    pub fn deinit(self: *MotionSensor) void {
    ...
    pub fn update(self: *MotionSensor, json: std.json.ObjectMap) bool {
        var changed = false;
    ...
    pub fn clone(self: *const MotionSensor, alloc: std.mem.Allocator) !MotionSensor {
        var sw: MotionSensor = .{
            .alloc = alloc,
            .id = "",
            .name = "",
    ...
    pub fn revert(self: *MotionSensor, source: *const MotionSensor) void {
        _ = self;
        _ = source;
    }

    pub fn merge(self: *MotionSensor, old: *const MotionSensor, new: *const MotionSensor) void {
    ...
    pub fn diff(
        self: *const MotionSensor,
        src: *const MotionSensor,
        a: std.mem.Allocator,
