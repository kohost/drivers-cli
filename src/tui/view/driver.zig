...
const DimmerView = @import("detail/dimmer.zig").DimmerView;
const LockView = @import("detail/lock.zig").LockView;
const MediaSourceView = @import("detail/media_source.zig").MediaSourceView;
const MotionSensorView = @import("detail/motion_sensor.zig").MotionSensorView;
const SwitchView = @import("detail/switch.zig").SwitchView;
const ThermostatView = @import("detail/thermostat.zig").ThermostatView;
